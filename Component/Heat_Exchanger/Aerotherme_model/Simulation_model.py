...
class Dry_cooler:
    ...
    class Exchanger:
        ...
        def __init__(self, Tw_in, Ta, Qw, parameters):
            ...
            "Flow data (air)"
            self.Qa = 106500 / 3600 / 4  # Volume flow rate [m^3/s]
        ...
        def set_next_exch_air(self, exch, fan=True): #Fan set on by default
            ...
            Parameters:
            exch (HeatExchanger): The next heat exchanger object for air flow.
            fan (bool): The fan used in the heat exchanger.
        ...
        def set_fin_link(self, exch, fan):
            """
            Links the Heat exchanger to the fan.

            Parameters:
            exch (HeatExchanger): The heat exchanger object to be linked.
            fan (Fan): The fan object to be linked.
